...
#ifndef _H_UICMMCTRL_H_
#define _H_UICMMCTRL_H_
...
#define DEFINECMMCTRLCLASST(classT,baseT) \
	template<class TBase = UIWnd> \
	class classT : public baseT<TBase> \
	{ \
		typedef classT<TBase> This; \
		typedef baseT<TBase> Base; \
	public: \
		classT(HWND hWnd = NULL) : Base(hWnd) { } \
		This & operator =(HWND hWnd) { m_hWnd = hWnd; return *this; } \
	}; 

#define DEFINECMMCTRLCLASS(classname,classT) typedef classT<UIWnd> classname;

DEFINECMMCTRLCLASST(UIStaticT,CStaticT)
DEFINECMMCTRLCLASS(UIStatic,UIStaticT)

/*template<class TBase = UIWnd>
class UIStaticT : public CStaticT<TBase>
{
	typedef UIStaticT<TBase> This;
	typedef CStaticT<TBase> Base;
public:
	UIStaticT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIStaticT<UIWnd> UIStatic;*/

template<class TBase = UIWnd>
class UIListBoxT : public CListBoxT<TBase>
{
	typedef UIListBoxT<TBase> This;
	typedef CListBoxT<TBase> Base;
public:
	UIListBoxT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIListBoxT<UIWnd> UIListBox;

template<class TBase = UIWnd>
class UIComboBoxT : public CComboBoxT<TBase>
{
	typedef UIComboBoxT<TBase> This;
	typedef CComboBoxT<TBase> Base;
public:
	UIComboBoxT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIComboBoxT<UIWnd> UIComboBox;

template<class TBase = UIWnd>
class UIEditT : public CEditT<TBase>
{
	typedef UIEditT<TBase> This;
	typedef CEditT<TBase> Base;
public:
	UIEditT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIEditT<UIWnd> UIEdit;

template<class T>
class UIEditCommands : public CEditCommands<T>
{

};

template<class TBase = UIWnd>
class UIScrollBarT : public CScrollBarT<TBase>
{
	typedef UIScrollBarT<TBase> This;
	typedef CScrollBarT<TBase> Base;
public:
	UIScrollBarT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIScrollBarT<UIWnd> UIScrollBar;

template<class TBase = UIWnd>
class UIButtonT : public CButtonT<TBase>
{
	typedef UIButtonT<TBase> This;
	typedef CButtonT<TBase> Base;
public:
	UIButtonT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIButtonT<UIWnd> UIButton;

template<class TBase = UIWnd>
class UIListCtrlT : public CListViewCtrlT<TBase>
{
	typedef UIListCtrlT<TBase> This;
	typedef CListViewCtrlT<TBase> Base;
public:
	UIListCtrlT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIListCtrlT<UIWnd> UIListCtrl;

template<class TBase = UIWnd>
class UITreeCtrlT : public CTreeViewCtrlT<TBase>
{
	typedef UITreeCtrlT<TBase> This;
	typedef CTreeViewCtrlT<TBase> Base;
public:
	UITreeCtrlT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UITreeCtrlT<UIWnd> UITreeCtrl;

template<class TBase = UIWnd>
class UITreeItemT : public CTreeItemT<TBase>
{

};
typedef UITreeItemT<UIWnd> UITreeItem;

template<class TBase = UIWnd>
class UITreeCtrlExT : public CTreeViewCtrlExT<TBase>
{
	typedef UITreeCtrlExT<TBase> This;
	typedef CTreeViewCtrlExT<TBase> Base;
public:
	UITreeCtrlExT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UITreeCtrlExT<UIWnd> UITreeCtrlEx;

template<class TBase = UIWnd>
class UIHeaderCtrlT : public CHeaderCtrlT<TBase>
{
	typedef UIHeaderCtrlT<TBase> This;
	typedef CHeaderCtrlT<TBase> Base;
public:
	UIHeaderCtrlT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIHeaderCtrlT<UIWnd> UIHeaderCtrl;

template<class TBase = UIWnd>
class UIToolBarCtrlT : public CToolBarCtrlT<TBase>
{
	typedef CToolBarCtrlT<TBase> Base;
public:
	// Construction
	UIToolBarCtrlT(HWND hWnd = NULL) : Base(hWnd)
	{ }

	UIToolBarCtrlT< TBase >& operator =(HWND hWnd)
	{
		m_hWnd = hWnd;
		return *this;
	}
};
typedef UIToolBarCtrlT<UIWnd> UIToolBarCtrl;

template<class TBase = UIWnd>
class UIStatusBarCtrlT : public CStatusBarCtrlT<TBase>
{
	typedef UIStatusBarCtrlT<TBase> This;
	typedef CStatusBarCtrlT<TBase> Base;
public:
	UIStatusBarCtrlT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIStatusBarCtrlT<UIWnd> UIStatusBarCtrl;

template<class TBase = UIWnd>
class UITabCtrlT : public CTabCtrlT<TBase>
{
	typedef UITabCtrlT<TBase> This;
	typedef CTabCtrlT<TBase> Base;
public:
	UITabCtrlT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UITabCtrlT<UIWnd> UITabCtrl;

class UIToolInfo : public CToolInfo
{
public:
	UIToolInfo(UINT nFlags, HWND hWnd, UINT nIDTool = 0, LPRECT lpRect = NULL, LPTSTR lpstrText = LPSTR_TEXTCALLBACK, LPARAM lUserParam = NULL)
		:CToolInfo(nFlags, hWnd, nIDTool, lpRect, lpstrText, lUserParam)
	{
...
template<class TBase = UIWnd>
class UIToolTipCtrlT : public CToolTipCtrlT<TBase>
{
	typedef UIToolTipCtrlT<TBase> This;
	typedef CToolTipCtrlT<TBase> Base;
public:
	UIToolTipCtrlT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIToolTipCtrlT<UIWnd> UIToolTipCtrl;

template<class TBase = UIWnd>
class UITrackBarCtrlT : public CTrackBarCtrlT<TBase>
{
	typedef UITrackBarCtrlT<TBase> This;
	typedef CTrackBarCtrlT<TBase> Base;
public:
	UITrackBarCtrlT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UITrackBarCtrlT<UIWnd> UITrackBarCtrl;

template<class TBase = UIWnd>
class UIUpDownCtrlT : public CUpDownCtrlT<TBase>
{
	typedef UIUpDownCtrlT<TBase> This;
	typedef CUpDownCtrlT<TBase> Base;
public:
	UIUpDownCtrlT(HWND hWnd = NULL) : Base(hWnd)
	{ }
...
typedef UIUpDownCtrlT<UIWnd> UIUpDownCtrl;

template<class TBase = UIWnd>
class UIProgressBarCtrlT : public CProgressBarCtrlT<TBase>
{

};
typedef UIProgressBarCtrlT<UIWnd> UIProgressBarCtrl;

template<class TBase = UIWnd>
class UIHotKeyCtrlT : public CHotKeyCtrlT<TBase>
{

};
typedef UIHotKeyCtrlT<UIWnd> UIHotKeyCtrl;

template<class TBase = UIWnd>
class UIAnimateCtrlT : public CAnimateCtrlT<TBase>
{

};
typedef UIAnimateCtrlT<UIWnd> UIAnimateCtrl;

template<class TBase = UIWnd>
class UIRichEditCtrlT : public CRichEditCtrlT<TBase>
{

};
typedef UIRichEditCtrlT<UIWnd> UIRichEditCtrl;

template<class T>
class UIRichEditCommands : public CRichEditCommands<T>
{

};

template<class TBase = UIWnd>
class UIDragListBoxT : public CDragListBoxT<TBase>
{

};
typedef UIDragListBoxT<UIWnd> UIDragListBox;

template<class T>
class DragListNotifyImpl : public CDragListNotifyImpl<T>
{

};

template<class TBase = UIWnd>
class UIReBarCtrlT : public CReBarCtrlT<TBase>
{

};
typedef UIReBarCtrlT<UIWnd> UIReBarCtrl;

template<class TBase = UIWnd>
class UIComboBoxExT : public CComboBoxExT<TBase>
{

};
typedef UIComboBoxExT<UIWnd> UIComboBoxEx;

template<class TBase = UIWnd>
class UIDateTimePickerCtrlT : public CDateTimePickerCtrlT<TBase>
{

};
typedef UIDateTimePickerCtrlT<UIWnd> UIDateTimePickerCtrl;

template<class TBase = UIWnd>
class UIMonthCalendarCtrlT : public CMonthCalendarCtrlT<TBase>
{

};
typedef UIMonthCalendarCtrlT<UIWnd> UIMonthCalendarCtrl;

template<class T>
class UIFlatScrollBarImpl : public CFlatScrollBarImpl<T>
{

};

template<class TBase = UIWnd>
class UIFlatScrollBarT : public CFlatScrollBarT<TBase>
{

};
typedef UIFlatScrollBarT<UIWnd> UIFlatScrollBar;

template<class TBase = UIWnd>
class UIIPAddressCtrlT : public CIPAddressCtrlT<TBase>
{

};
typedef UIIPAddressCtrlT<UIWnd> UIIPAddressCtrl;

template<class TBase = UIWnd>
class UIPagerCtrlT : public CPagerCtrlT<TBase>
{

};
typedef UIPagerCtrlT<UIWnd> UIPagerCtrl;

#if (_WIN32_WINNT >= 0x0501) && !defined(_WIN32_WCE)

template<class TBase = UIWnd>
class UILinkCtrlT : public CLinkCtrlT<TBase>
{

};
typedef UILinkCtrlT<UIWnd> UILinkCtrl;
...
template<class TBase = UIWnd>
class UICECommandBarCtrlT : public CCECommandBarCtrlT<TBase>
{

};
typedef UICECommandBarCtrlT<UIWnd> UICECommandBarCtrl;

template<class TBase = UIWnd>
class UICECommandBandsCtrlT : public CCECommandBandsCtrlT<TBase>
{

};
typedef UICECommandBandsCtrlT<UIWnd> UICECommandBandsCtrl;

#endif//_WIN32_WCE

///////////////////////////////////////////////////////////////////////////////
// UICommandBarCtrlBase - base class for the Command Bar implementation

class UICommandBarCtrlBase : public UIToolBarCtrl
{
public:
	struct _MsgHookData
	{
	...
	static UICommandBarCtrlBase* s_pCurrentBar;
	...
	UICommandBarCtrlBase() : m_hWndHook(NULL), m_dwMagic(1314)
	{
		...
		if(!s_bStaticInit)
		{
			...
			if(FAILED(lock.Lock()))
			{
				ATLTRACE2(atlTraceUI, 0, _T("ERROR : Unable to lock critical section in UICommandBarCtrlBase::UICommandBarCtrlBase.\n"));
				ATLASSERT(FALSE);
				return;
			}
...
__declspec(selectany) UICommandBarCtrlBase::CMsgHookMap* UICommandBarCtrlBase::s_pmapMsgHook = NULL;
__declspec(selectany) HHOOK UICommandBarCtrlBase::s_hCreateHook = NULL;
__declspec(selectany) UICommandBarCtrlBase* UICommandBarCtrlBase::s_pCurrentBar = NULL;
__declspec(selectany) bool UICommandBarCtrlBase::s_bW2K = false;
__declspec(selectany) bool UICommandBarCtrlBase::s_bStaticInit = false;

///////////////////////////////////////////////////////////////////////////////
// UICommandBarCtrl - ATL implementation of Command Bars

template <class T, class TBase = UICommandBarCtrlBase, class TWinTraits = ATL::CControlWinTraits>
class UICommandBarCtrlImpl : public UIWndImpl< T, TBase, TWinTraits >
{
public:
	...
	{
		// Use UIMDICommandBarCtrl for MDI support
		ATLASSERT(FALSE);
		return FALSE;
	}

	// Message map and handlers
	BEGIN_MSG_MAP(UICommandBarCtrlImpl)
	...
	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& /*bHandled*/)
	{
		...
		if(FAILED(lock.Lock()))
		{
			ATLTRACE2(atlTraceUI, 0, _T("ERROR : Unable to lock critical section in UICommandBarCtrlImpl::OnCreate.\n"));
			ATLASSERT(FALSE);
			return -1;
		}
	...
	LRESULT OnDestroy(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& /*bHandled*/)
	{
		...
		if(FAILED(lock.Lock()))
		{
			ATLTRACE2(atlTraceUI, 0, _T("ERROR : Unable to lock critical section in UICommandBarCtrlImpl::OnDestroy.\n"));
			ATLASSERT(FALSE);
			return lRet;
		}
	...
	LRESULT OnInternalGetBar(UINT /*uMsg*/, WPARAM wParam, LPARAM /*lParam*/, BOOL& /*bHandled*/)
	{
		...
		if(IsWindowVisible())
			return (LRESULT)static_cast<UICommandBarCtrlBase*>(this);
		else
			return NULL;
	}
	...
	static LRESULT CALLBACK MessageHookProc(int nCode, WPARAM wParam, LPARAM lParam)
	{
		...
		{
			UICommandBarCtrlBase* pCmdBar = NULL;
			HWND hWnd = pMsg->hwnd;
			DWORD dwPID = 0;
			while(pCmdBar == NULL && hWnd != NULL)
			{
				pCmdBar = (UICommandBarCtrlBase*)::SendMessage(hWnd, GetGetBarMessage(), (WPARAM)&dwPID, 0L);
				hWnd = ::GetParent(hWnd);
			}
	...
	BOOL DoTrackPopupMenu(HMENU hMenu, UINT uFlags, int x, int y, LPTPMPARAMS lpParams = NULL)
	{
		...
		if(FAILED(lock.Lock()))
		{
			ATLTRACE2(atlTraceUI, 0, _T("ERROR : Unable to lock critical section in UICommandBarCtrlImpl::DoTrackPopupMenu.\n"));
			ATLASSERT(FALSE);
			return FALSE;
		}
		...
		s_pCurrentBar = static_cast<UICommandBarCtrlBase*>(this);
	...
	static UINT GetAutoPopupMessage()
	{
		...
		if(uAutoPopupMessage == 0)
		{
			...
			if(FAILED(lock.Lock()))
			{
				ATLTRACE2(atlTraceUI, 0, _T("ERROR : Unable to lock critical section in UICommandBarCtrlImpl::GetAutoPopupMessage.\n"));
				ATLASSERT(FALSE);
				return 0;
			}
	...
	static UINT GetGetBarMessage()
	{
		...
		if(uGetBarMessage == 0)
		{
			...
			if(FAILED(lock.Lock()))
			{
				ATLTRACE2(atlTraceUI, 0, _T("ERROR : Unable to lock critical section in UICommandBarCtrlImpl::GetGetBarMessage.\n"));
				ATLASSERT(FALSE);
				return 0;
			}
...
class UICommandBarCtrl : public UICommandBarCtrlImpl<UICommandBarCtrl>
{
public:
	DECLARE_WND_SUPERCLASS(_T("UI_CommandBar"), GetWndClassName())
};


///////////////////////////////////////////////////////////////////////////////
// UIMDICommandBarCtrl - ATL implementation of Command Bars for MDI apps

template <class T, class TBase = UICommandBarCtrlBase, class TWinTraits = ATL::CControlWinTraits>
class ATL_NO_VTABLE UIMDICommandBarCtrlImpl : public UICommandBarCtrlImpl< T, TBase, TWinTraits>
{
public:
	// Data members
	...
	// Message maps
	typedef UICommandBarCtrlImpl< T, TBase, TWinTraits >   _baseClass;
	BEGIN_MSG_MAP(UIMDICommandBarCtrlImpl)
		MESSAGE_HANDLER(WM_CREATE, OnCreate)
		MESSAGE_HANDLER(WM_DESTROY, OnDestroy)
#ifndef _WTL_NO_AUTO_THEME
...
class UIMDICommandBarCtrl : public UIMDICommandBarCtrlImpl<UIMDICommandBarCtrl>
{
public:
	DECLARE_WND_SUPERCLASS(_T("UI_MDICommandBar"), GetWndClassName())
};

template <class T, class TBase = UIButton, class TWinTraits = ATL::CControlWinTraits>
class ATL_NO_VTABLE UIBitmapButtonImpl : public CBitmapButtonImpl<T, TBase, TWinTraits>
{
};

class UIBitmapButton : public UIBitmapButtonImpl<UIBitmapButton>
{
public:
	DECLARE_WND_SUPERCLASS(_T("UI_BitmapButton"), GetWndClassName())
};

template <class T, class TBase = UIWnd, class TWinTraits = ATL::CControlWinTraits>
class ATL_NO_VTABLE UIHyperLinkImpl : public CHyperLinkImpl< T, TBase, TWinTraits >
{
};

class UIHyperLink : public UIHyperLinkImpl<UIHyperLink>
{
public:
	DECLARE_WND_SUPERCLASS(_T("UI_HyperLink"), GetWndClassName())
};

template <class T, class TBase = UIListCtrl, class TWinTraits = CCheckListViewCtrlTraits>
class ATL_NO_VTABLE UICheckListViewCtrlImpl : public CCheckListViewCtrlImpl< T, TBase, TWinTraits >
{
};

class UICheckListViewCtrl : public UICheckListViewCtrlImpl<UICheckListViewCtrl>
{
public:
	DECLARE_WND_SUPERCLASS(_T("UI_CheckListViewCtrl"), GetWndClassName())
};

template<class T>
class UICustomDraw : public CCustomDraw<T>
{
public:
	BEGIN_MSG_MAP_EX(UICustomDraw<T>)
...
template<class T>
class UIOwnerDraw : public COwnerDraw<T>
{
public:
	BEGIN_MSG_MAP_EX(UIOwnerDraw<T>)
	...
	{
		T* pT = static_cast<T*>(this);
		return pT->OnCtlColor(hdc, hWnd, CTLCOLOR_EDIT);
	}

	HBRUSH OnCtlColorListBox(HDC hdc, HWND hWnd)
	{
		T* pT = static_cast<T*>(this);
		return pT->OnCtlColor(hdc, hWnd, CTLCOLOR_LISTBOX);
	}

	HBRUSH OnCtlColorBtn(HDC hdc, HWND hWnd)
	{
		T* pT = static_cast<T*>(this);
		return pT->OnCtlColor(hdc, hWnd, CTLCOLOR_BTN);
	}

	HBRUSH OnCtlColorDlg(HDC hdc, HWND hWnd)
	{
		T* pT = static_cast<T*>(this);
		return pT->OnCtlColor(hdc, hWnd, CTLCOLOR_DLG);
	}

	HBRUSH OnCtlColorScrollBar(HDC hdc, HWND hWnd)
	{
		T* pT = static_cast<T*>(this);
		return pT->OnCtlColor(hdc, hWnd, CTLCOLOR_SCROLLBAR);
	}

	HBRUSH OnCtlColorStatic(HDC hdc, HWND hWnd)
	{
		T* pT = static_cast<T*>(this);
		return pT->OnCtlColor(hdc, hWnd, CTLCOLOR_STATIC);
	}
...
template <class T>
class UITabCtrlOwnerDraw : public UIPaint<T>
{
public:
	BEGIN_MSG_MAP(UITabCtrlOwnerDraw)
		CHAIN_MSG_MAP(UIPaint<T>)
	END_MSG_MAP()

	BOOL OnEraseBkgnd(HDC hdc)
	{
		T* pT = static_cast<T*>(this);
		if (!(pT->GetStyle() & TCS_OWNERDRAWFIXED)) {
			return FALSE;
		}
		return TRUE;
	}
	...
	void OnPaint(HDC hdc)
	{
		...
		HFONT hOldFont = (HFONT)dc.SelectFont(pT->GetFont());

		DRAWITEMSTRUCT dis = {0};
		//ZeroMemory(&dis, sizeof DRAWITEMSTRUCT);

		dis.CtlType = ODT_TAB;
		dis.CtlID = pT->GetDlgCtrlID();
		dis.hwndItem = *pT;
		dis.hDC = dc;
		dis.itemAction = ODA_DRAWENTIRE;
		pT->GetClientRect(&dis.rcItem);
		pT->DrawItem(&dis);
		...
		while (nCount--) {
			pT->GetItemRect(nCount, &dis.rcItem);
	...
	{
		T* pT = static_cast<T*>(this);
		SendMessage(pT->GetParent(), WM_DRAWITEM, (WPARAM)lpDrawItemStruct->CtlID, (LPARAM)lpDrawItemStruct);
	}
};

template <class T>
class UIMenuOwnerDraw
{
protected:
...
public:
	...
	BEGIN_MSG_MAP_EX(UIMenuOwnerDraw)
	...
	{
		T* pT = static_cast<T*>(this);
		pT->InitMenuPopup(hMenu, nIndex, bSysMenu);
	}

	void OnMenuSelect(UINT nItemID, UINT nFlags, HMENU hMenu)
	{
		T* pT = static_cast<T*>(this);
		pT->MenuSelect(nItemID, nFlags, hMenu);
	}
	...
	void InitMenuPopup(HMENU hMenu, UINT nIndex, BOOL bSysMenu)
	{
		if (bSysMenu) {
			SetMsgHandled(FALSE);
			return ;
		...
		T* pT = static_cast<T*>(this);
		CMenuHandle menuPopup = (HMENU)hMenu;
		for (int i = 0; i < menuPopup.GetMenuItemCount(); i++)
		{
			BOOL bRet = FALSE;
			...
			if (!(mii.fType & MFT_OWNERDRAW)) {
				mii.fType |= MFT_OWNERDRAW; // Make this menu item an owner-drawn
				/*MenuItemData * pMI = new MenuItemData;
				pMI->fType = mii.fType;
				pMI->fState = mii.fState;
				lstrcpy(pMI->szText, szText);
				mii.dwItemData = (ULONG_PTR)pMI;*/
				mii.dwItemData = (ULONG_PTR)hMenu;
				bRet = menuPopup.SetMenuItemInfo(i, TRUE, &mii);
			}
		}
		// Add it to the list
		m_stackMenuHandle.Push(hMenu);
	}	
	void MenuSelect(UINT nItemID, UINT nFlags, HMENU hMenu)
	{
		SetMsgHandled(FALSE);

		// Check if a menu is closing, do a cleanup
		if (nFlags == (UINT)-1 && hMenu == NULL)   // Menu closing
		{
			// Restore the menu items to the previous state for all menus that were converted
			while ((hMenu = m_stackMenuHandle.Pop()) != NULL)
			{
	...
	void MeasureItem(LPMEASUREITEMSTRUCT lpMeasureItemStruct)
	{
		...
		CMenuHandle menuPopup = (HMENU)lpMeasureItemStruct->itemData;
		CMenuItemInfo mii;
		mii.fMask = MIIM_DATA | MIIM_TYPE;
		if(!menuPopup.GetMenuItemInfo(lpMeasureItemStruct->itemID, FALSE, &mii))
			return;
	...
	void DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
	{
		...
		CMenuHandle menuPopup = (HMENU)lpDrawItemStruct->itemData;
		TCHAR szText[MAX_PATH] = {0};
		CMenuItemInfo mii;
		mii.cch = MAX_PATH;
		mii.dwTypeData = szText;
		mii.fMask = MIIM_CHECKMARKS | MIIM_DATA | MIIM_ID | MIIM_STATE | MIIM_SUBMENU | MIIM_TYPE;
		if(!menuPopup.GetMenuItemInfo(lpDrawItemStruct->itemID, FALSE, &mii))
			return;
		...
		if (mii.fType & MFT_SEPARATOR) {
			...
			// Draw the text
			CString sCaption = szText;
			int nTab = sCaption.Find('\t');
			if (nTab >= 0) {
				sCaption = sCaption.Left(nTab);
			}
			dc.SetTextColor(bDisabled ? ::GetSysColor(COLOR_3DFACE) : ::GetSysColor(COLOR_MENUTEXT));
			dc.SetBkMode(TRANSPARENT);
			dc.DrawText(sCaption, sCaption.GetLength(), &rcItem, DT_SINGLELINE|DT_VCENTER|DT_LEFT);
			if (nTab >= 0) {    
				//dc.DrawText(pmd->lpstrText + nTab + 1, _tcslen(pmd->lpstrText + nTab + 1), rc, DT_SINGLELINE|DT_VCENTER|DT_RIGHT);
			}
			if (bChecked) {
...
template <class T ,class TT = UIToolTipCtrl>  
class UIToolTipMap
{  
	typedef UIToolTipMap<T,TT> This;
public:
	UIToolTipMap(UINT uTTSTyle= TTS_NOPREFIX | TTS_BALLOON | TTS_ALWAYSTIP, UINT uTTFlags = TTF_IDISHWND | TTF_SUBCLASS)
		:m_pTT(NULL), m_uTTStyle(uTTSTyle)
		,m_uTTFlags(uTTFlags | TTF_SUBCLASS)
	{
	...
	// Operations  
public:  
	void TTSetDelayTime(DWORD dwType, int nTime)
	{
		if (m_pTT) {
			m_pTT->SetDelayTime(dwType, nTime);
		}
	}
	void TTActivate(BOOL bActivate)  
	{ 
		if (m_pTT) {
			m_pTT->Activate(bActivate); 
		}
	}  
	...
	{
		if (m_pTT) {
			m_pTT->SetMaxTipWidth(nPixel);
		}
	}  
	void TTSetText(HWND hTool, _U_STRINGorID text)  
	{ 
		if (m_pTT) {
			m_pTT->UpdateTipText(text, hTool);
		}
	}  
	void TTSetText(UINT idTool, _U_STRINGorID text)
	{ 
		T* pT= static_cast<T*>(this);
		TTSetText(pT->GetDlgItem(idTool), text);
	}  
	BOOL TTAdd(HWND hTool)  
	{ 
		T* pT= static_cast<T*>(this);
		return SetTool(hTool, (LPARAM)pT);
	}  
	BOOL TTAdd(UINT idTool)  
	{ 
		T* pT= static_cast<T*>(this);
		return TTAdd(pT->GetDlgItem(idTool));
	}  
	...
	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)  
	{
		...
		T* pT= static_cast<T*>(this);
		m_pTT = new TT;
		m_pTT->Create(*pT, NULL, NULL, m_uTTStyle);
		TTSetDelayTime(TTDT_RESHOW, 1000);			//鼠标划上后1秒弹出提示  
		TTSetDelayTime(TTDT_AUTOPOP, 10000);		//弹出提示后停留10秒钟
		TTSize(0);  
		TTActivate(TRUE);
		return 0;  
	}  
	...
	{  
		...
		T* pT= static_cast<T*>(this);
		if(m_pTT)  
			m_pTT->RelayEvent((LPMSG)pT->GetCurrentMessage());
		return 0;  
	}  
...
protected:  
	...
	static BOOL CALLBACK SetTool(HWND hTool, LPARAM lParam)
	{
		T* pT = reinterpret_cast<T*>(lParam);
		if (pT && pT->m_pTT) {
			int idTool = ::GetWindowLong(hTool, GWL_ID); 
			if (idTool != IDC_STATIC) {
				UIToolInfo ToolInfo(pT->m_uTTFlags, hTool, 0, 0, (LPTSTR)idTool);
				pT->m_pTT->AddTool(&ToolInfo);
			}
		}
		return TRUE;  
	}
...
class ATL_NO_VTABLE UIPaneContainerImpl : public CPaneContainerImpl<T, TBase, TWinTraits>
{
public:
};

class UIPaneContainer : public UIPaneContainerImpl<UIPaneContainer>
{
public:
	DECLARE_WND_CLASS_EX(_T("UIPaneContainer"), 0, -1)
};

#else

typedef CControlBar UIControlBar;

template<class T, class TBase = UIControlBar>
class UICtrlImpl : public UIWndImpl<T,TBase>
{
	typedef UICtrlImpl<T, TBase> This;
	typedef UIWndImpl<T, TBase> Base;
public:
	UICtrlImpl(HWND hWnd = NULL):Base(hWnd) { }
};
/*
#define DEFINECMMCTRLCLASS(classname,basename) \
	class classname : public UICtrlImpl<classname,basename> \
	{ \
		typedef classname This; \
		typedef UICtrlImpl<classname,basename> Base; \
	public: \
		classname(HWND hWnd = NULL) : Base(hWnd) { } \
		This & operator =(HWND hWnd) { m_hWnd = hWnd; return *this; } \
	}; 

DEFINECMMCTRLCLASS(UIStatic,CStatic)
DEFINECMMCTRLCLASS(UIListBox,CListBox)
DEFINECMMCTRLCLASS(UIComboBox,CComboBox)
DEFINECMMCTRLCLASS(UIEdit,CEdit)
DEFINECMMCTRLCLASS(UIScrollBar,CScrollBar)
DEFINECMMCTRLCLASS(UIButton,CButton)
DEFINECMMCTRLCLASS(UIListCtrl,CListCtrl)
DEFINECMMCTRLCLASS(UITreeCtrl,CTreeCtrl)
DEFINECMMCTRLCLASS(UIHeaderCtrl,CHeaderCtrl)
DEFINECMMCTRLCLASS(UIToolBar,CToolBar)
DEFINECMMCTRLCLASS(UIStatusBar,CStatusBar)
DEFINECMMCTRLCLASS(UITabCtrl,CTabCtrl)
DEFINECMMCTRLCLASS(UIToolTipCtrl,CToolTipCtrl)
DEFINECMMCTRLCLASS(UISpinButtonCtrl,CSpinButtonCtrl)
DEFINECMMCTRLCLASS(UIProgressCtrl,CProgressCtrl)
DEFINECMMCTRLCLASS(UIHotKeyCtrl,CHotKeyCtrl)
DEFINECMMCTRLCLASS(UIAnimateCtrl,CAnimateCtrl)
DEFINECMMCTRLCLASS(UIRichEditCtrl,CRichEditCtrl)
DEFINECMMCTRLCLASS(UIDragListBox,CDragListBox)
DEFINECMMCTRLCLASS(UIReBarCtrl,CReBarCtrl)
DEFINECMMCTRLCLASS(UIComboBoxEx,CComboBoxEx)
DEFINECMMCTRLCLASS(UIDateTimeCtrl,CDateTimeCtrl)
DEFINECMMCTRLCLASS(UIMonthCalCtrl,CMonthCalCtrl)
DEFINECMMCTRLCLASS(UIIPAddressCtrl,CIPAddressCtrl)
DEFINECMMCTRLCLASS(UIPagerCtrl,CPagerCtrl)
#if (_WIN32_WINNT >= 0x0501) && !defined(_WIN32_WCE)
DEFINECMMCTRLCLASS(UILinkCtrl,CLinkCtrl)
#endif//(_WIN32_WINNT >= 0x0501) && !defined(_WIN32_WCE)
DEFINECMMCTRLCLASS(UIBitmapButton,CBitmapButton)*/
...
class UIScrollBar : public CScrollBar
{
public:
...
class UILinkCtrl : public CLinkCtrl
{
public:
...
template<class T>
class UIEraseBkgndCtrl : public UIEraseBkgnd<T>
{
public:
	BEGIN_MSG_MAP(UIEraseBkgndCtrl)
		CHAIN_MSG_MAP(UIEraseBkgnd<T>)
	END_MSG_MAP()
	...
	BOOL OnEraseBkgnd(HDC hdc)
	{
		...
		bEraseBkgnd = (BOOL)wndParent.SendMessage(WM_ERASEBKGND, (WPARAM)(HDC)dc, 0L);
		dc.SetWindowOrg(pt.x, pt.y);
#else
		CWnd* pParent = pT->GetParent();
		CPoint pt(0, 0);
		pT->MapWindowPoints(pParent, &pt, 1);
		pt = ::OffsetWindowOrgEx(hdc, pt.x, pt.y, NULL);
		bEraseBkgnd = (BOOL)pParent->SendMessage(WM_ERASEBKGND, (WPARAM)hdc, 0L);
...
template<class T>
class UIPaintCtrl : public UIPaint<T>
{
public:
	BEGIN_MSG_MAP(UIPaintCtrl)
		CHAIN_MSG_MAP(UIPaint<T>)
	END_MSG_MAP()
	...
	void OnPaint(HDC hdc)
	{
		...
		pT->DefWindowProc(WM_PAINT, (WPARAM)(HDC)dc, (LPARAM)0L);
		...
		pDC->SetWindowOrg(hdc, pt.x, pt.y);
...
template<class T>
class UIPaintFCtrl : public UIPaintF<T>
{
public:
	BEGIN_MSG_MAP(UIPaintFCtrl)
...
class UIButtonMap
{
	typedef UIButtonMap<T> This;
public:

	BEGIN_MSG_MAP(This)
		//MESSAGE_HANDLER(WM_LBUTTONDOWN, OnLButtonDown)
		//MESSAGE_HANDLER(WM_LBUTTONUP, OnLButtonUp)
		MESSAGE_HANDLER(WM_MOUSEMOVE, OnMouseMove) //使用hover有点慢
...
template<class T>
class UISysButtonMap : public UIButtonMap<T>
{
	typedef UISysButtonMap<T> This;
	typedef UIButtonMap<T> Base;
public:
